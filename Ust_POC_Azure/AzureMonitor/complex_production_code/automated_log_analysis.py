...
# Define the folder containing logs
log_folder = "complex_production_code"
log_file_name = "complex_pipeline_logs.txt"
log_file_path = os.path.join(log_folder, log_file_name)

# Define the report file
report_file_name = "complex_pipeline_analysis_report.txt"
